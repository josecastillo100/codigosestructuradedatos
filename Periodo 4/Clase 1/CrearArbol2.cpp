...
int main() {
  ...
  root->left->left->left = new BinaryTree(23);
  ...
  cout << "Bonita impresion de arbol con nivel = 1 e indentSpace = 0 \n\n";
  // Output to console
  printPretty(root, 1, 0, cout);

  cout << "\n\nBonita impresion de arbol con nivel = 5 e indentSpace = 3,\nsalida al archivo \"tree_pretty.txt \".\n\n";
